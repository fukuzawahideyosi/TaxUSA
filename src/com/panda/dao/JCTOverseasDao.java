 ...
 * 15:59
 */
public class JCTOverseasDao  extends ConnectionDao {

	private static Logger logger = Logger.getLogger(JCTOverseasDao.class.toString());
...
//					+ "     ) temp"
	...
	public static String selectUpdateDateMax() {
