...
@WebServlet("/SearchJCTLogic")
public class SearchJCTLogic extends HttpServlet {

    private static Logger logger = Logger.getLogger(SearchJCTLogic.class.toString());
	...
	public void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		maListJCT = JCTDao.select(req, pageNo, pageSize, HashMap);
		session.setAttribute("maListJCT", maListJCT);
		logger.debug("maListJCT " + maListJCT.size());

		int maListJCTSize = JCTDao.selectSize(req);
		...
		req.getRequestDispatcher("/searchJCT.jsp").forward(req,resp);
